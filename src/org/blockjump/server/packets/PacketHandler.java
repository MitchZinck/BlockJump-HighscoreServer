...
public class PacketHandler implements Runnable {
    ...
    public void write(PacketBuffer packet, OutputStream out)
            throws IOException {
    ...
    public void handle(Connection c) throws IOException {
        ...
        switch (opCode) {
            case 0: // Get highscore of given username back
                ArrayList<User> userList = sqlManager
                        .getHighscore(c.getBuffer().substring(1));
                ...
                Log.log("Successfully returned highscores of "
                        + c.getBuffer().substring(1) + " to: "
                        + c.getChannel().getRemoteAddress(),
                        MessageState.ENGINE);
                break;
            ...
            case 2:
                ...
                Log.log("Successfully added highscore of " + name + " from: "
                        + c.getChannel().getRemoteAddress(),
                        MessageState.ENGINE);
                break;
